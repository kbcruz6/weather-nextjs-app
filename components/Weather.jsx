...
const Weather = ({ data }) => {
  ...
  return (
    ...
    >
      {/*//! Title */}
      <p className="text-6xl my-6 text-center font-bold text-shadow">
        {data.name}
      </p>
      {/*//! Right now weather  */}
      <div className=" mb-10 flex justify-between items-center ">
        <div className="bg-white/30 rounded-2xl flex flex-col items-center font-bold text-shadow p-4 shadow-md shadow-black">
          <Image
